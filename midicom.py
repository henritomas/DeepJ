...
if __name__ == "__main__":
    ...
    nra = note_rate(midA, True)
    nua, mnca = note_usage(midA)
    nrb = note_rate(mid0, False)
    nub, mncb = note_usage(mid0)

    nrc = note_rate(midB, True)
    nuc, mncc = note_usage(midB)

    print("Bach 846")
    print(f"Notes per second: {nra}")
    print(f"Note Usage Ratio: {nua}")
    print(f"Mean Note Change: {mnca}")
    print("\n")
    print("Bor PS2")
    print(f"Notes per second: {nrc}")
    print(f"Note Usage Ratio: {nuc}")
    print(f"Mean Note Change: {mncc}")
    print("\n")
    print("Generated Midi")
    print(f"Note Rate per second: {nrb}")
    print(f"Note Usage Ratio: {nub}")
    print(f"Mean Note Change: {mncb}")